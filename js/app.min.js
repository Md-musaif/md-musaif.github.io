...
function mxdLoader() {
    ...
    if (function() {
        ...
        }() && !a) return mxdPageTransition(), void pageAppearance();
    ! function() {
        try {
            sessionStorage.setItem("mxd-visited", "true")
        } catch (e) {}
    }(), r.style.display = "flex", startLoader().play(), Promise.all([new Promise(e => t.on("done", e)), new Promise(e => setTimeout(e, 1200))]).then(() => {
        gsap.timeline().add(hideLoader()).add(() => {
            r.style.display = "none", mxdPageTransition(), pageAppearance()
        })
    })
}
...
function mxdPageTransition() {
    ...
    gsap.to(e, {
        ...
        !o || o.startsWith("#") || o.startsWith("mailto") || o.startsWith("tel") || "_blank" === t.target || t.hasAttribute("download") || t.addEventListener("click", o => {
            const r = t.href;
            o.preventDefault(), gsap.set(e, {
                y: "100%"
            }), gsap.to(e, {
                y: "0%",
                duration: .7,
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    e.on("scroll", ScrollTrigger.update), gsap.ticker.add(t => {
        e.raf(1e3 * t)
    }), gsap.ticker.lagSmoothing(0), gsap.registerPlugin(ScrollTrigger, CustomEase, SplitText, Flip, ScrollToPlugin, InertiaPlugin), CustomEase.create("hop", ".87, 0, .13, 1"), CustomEase.create("common", ".23, .65, .74, 1.09"), requestAnimationFrame(() => {
        ScrollTrigger.refresh()
    }), mxdLoader();
    let t = null;
    document.fonts.ready.then(() => {
        t = mxdMenu(e), mxdTypeAnimations()
    }), mxdHeroVideoScale(), mxdHeroVideoSwap(), mxdHero3dImages(), mxdHeroInertia(), mxdHeroHorizontal(), mxdHeroTyped(), mxdBlur(), mxdProjectsStack(), mxdServicesStack(), mxdLandingStack(), mxdProjectsClip(), mxdDvStickyMedia(), mxdDvStickyCaption(), mxdPin(), mxdToTop(), mxdSmoothScroll(), mxdGravity(), mxdStats(), mxdPerspectiveList(), mxdViewportHeight(), mxdColorSwitcher(), "desktop" === deviceType() ? (mxdCursor(), mxdCursorTrail(), mxdCursorTrailTr(), mxdTextScramble(), mxdHoverSlideshow(), mxdHeroBannersHover()) : document.getElementById("mxd-cursor").style.display = "none", window.addEventListener("pageshow", e => {
...
function startLoader() {
    ...
    return n.to(e, {
        ...
        duration: 1.2,
        onUpdate: function() {
            r = Math.min(Math.floor(100 * this.progress()), 100), o.textContent = r
        }
    }, 0), n.add(() => {
        gsap.set(t, {
            opacity: 0,
...
function mxdViewportHeight() {
    ...
    e(), window.addEventListener("resize", e), window.addEventListener("orientationchange", e)
}
...
function mxdMenu(e) {
    ...
    const n = document.querySelector(".mxd-menu__content"),
        ...
        i = document.querySelectorAll(".menu-logo__text span, .mxd-menu__caption p"),
    ...
    function m(e) {
        return e.length ? [...e].map(e => {
            const t = SplitText.create(e, {
                type: "lines",
                mask: "lines",
                linesClass: "line",
                aria: "none"
            });
            return gsap.set(t.lines, {
                y: "-114%"
            }), t
        }) : []
    }
    ...
    return t.addEventListener("click", t => {
        ...
        if (f) s?.classList.remove("active"), i.to(o, {
            ...
            [...g, ...h, ...y, ...x].forEach(e => gsap.set(e.lines, {
                y: "-114%"
            })), gsap.set(p, {
                clipPath: "inset(0% 100% 0% 0%)"
            }), gsap.set(u, {
            ...
            i.to(r, {
                background: t ? "rgba(var(--base-rgb), 0.6)" : "rgba(var(--base-rgb), 0.8)",
                ...
                duration: .75,
                ease: "power2.out"
            }, .5).to(x.flatMap(e => e.lines), {
                y: "0%",
                stagger: -.05,
                ease: "hop",
                duration: .75
            }, .15).to(h.flatMap(e => e.lines), {
                y: "0%",
                stagger: -.05,
                ease: "hop",
                duration: .75
                ...
                ease: "hop",
                duration: .75
            }, .15).to(y.flatMap(e => e.lines), {
                y: "0%",
                stagger: -.05,
                ease: "hop",
                duration: .75
            }, .15).to(g.flatMap(e => e.lines), {
                y: "0%",
                stagger: -.05,
                ease: "hop",
                duration: .75
        ...
        resetMenu: function() {
            gsap.set(o, {
                ...
                opacity: 0
            }), s?.classList.remove("active"), document.querySelectorAll(".submenu").forEach(e => {
                e.style.display = "none"
            }), document.querySelectorAll(".main-menu__item.open").forEach(e => {
                e.classList.remove("open")
            }), f = !1, S = !1, e?.start()
...
function mxdCursor() {
    ...
    const t = document.getElementById("mxd-cursor__dot"),
        ...
        n = (document.getElementById("mxd-cursor__image-tr"), document.querySelectorAll(".active-cursor-image")),
    ...
    window.addEventListener("pointermove", t => {
        ...
        t.clientY, gsap.to(e, {
            ...
            rotation: gsap.utils.clamp(-6, 6, .5 * o),
            duration: .3,
            ease: "power1.out"
        }), p = t.clientX, u = t.clientY
        ...
        e.style.transform = `translateX(${t.clientX}px) translateY(${t.clientY}px)`
        ...
        e.addEventListener("mouseenter", () => {
            o.innerText = e.dataset.cursorText || "", o.classList.add("show"), t.classList.add("active", "expand")
        }), e.addEventListener("mouseleave", () => {
            o.classList.remove("show"), t.classList.remove("active", "expand")
        })
    }), s.forEach(e => {
        e.addEventListener("mouseenter", () => {
            o.innerText = e.dataset.cursorText || "", o.classList.add("show", "permanent"), t.classList.add("active-permanent", "expand")
        }), e.addEventListener("mouseleave", () => {
            o.classList.remove("show", "permanent"), t.classList.remove("active-permanent", "expand")
        })
    }), i.forEach(e => {
        e.addEventListener("mouseenter", () => {
            o.innerText = e.dataset.cursorText || "", o.classList.add("show", "accent"), t.classList.add("active-accent", "expand")
        }), e.addEventListener("mouseleave", () => {
            o.classList.remove("show", "accent"), t.classList.remove("active-accent", "expand")
        })
    }), d.forEach(o => {
        o.addEventListener("mouseenter", () => {
            e.classList.add("difference"), t.classList.add("cursor-btn-link")
        }), o.addEventListener("mouseleave", () => {
            e.classList.remove("difference"), t.classList.remove("cursor-btn-link")
        })
    }), l.forEach(e => {
        ...
        e.addEventListener("mouseenter", () => {
            ...
            o && (r.innerHTML = `<img src="${o}" alt="">`, r.classList.add("show"), t.classList.add("expand"))
        }), e.addEventListener("mouseleave", () => {
            r.classList.remove("show"), setTimeout(() => {
                r.classList.contains("show") || (r.innerHTML = "")
            }, 300), t.classList.remove("expand")
        })
    }), a.forEach(e => {
        e.addEventListener("mouseenter", () => {
            const t = e.dataset.cursorImage;
            t && (r.innerHTML = `<img src="${t}" alt="">`, r.classList.add("show"))
        }), e.addEventListener("mouseleave", () => {
            r.classList.remove("show"), setTimeout(() => {
                r.classList.contains("show") || (r.innerHTML = "")
            }, 300)
    ...
    e && t.length && t.forEach(t => {
        gsap.timeline({
            scrollTrigger: {
                ...
                onEnterBack: () => gsap.set(e, {
                    display: "block"
                }),
                onLeaveBack: () => gsap.set(e, {
                    display: "none"
                })
            }
        })
...
function mxdPin() {
    ...
    t.add("(min-width: 1200px)", () => (e.forEach(e => {
        ...
        ScrollTrigger.getAll().forEach(e => {
            e.trigger && e.trigger.classList.contains("pinned-section") && e.kill()
        })
...
function mxdToTop() {
    ...
    e && (e.addEventListener("click", function(e) {
        e.preventDefault()
    }), e.addEventListener("click", () => gsap.to(window, {
        scrollTo: 0,
        ease: "hop",
        duration: 2
    })))
...
function mxdSmoothScroll() {
    document.querySelectorAll('a[href*="#"]:not([href="#"]):not([href="#0"])').forEach(e => {
        e.addEventListener("click", function(e) {
            const t = new URL(this.href),
                o = t.hash;
            if (!o) return;
            const r = document.querySelector(o);
            r && window.location.pathname === t.pathname && window.location.hostname === t.hostname && (e.preventDefault(), gsap.to(window, {
                scrollTo: {
                    y: r,
                    autoKill: !0
                },
...
function mxdGravity() {
    const e = document.querySelectorAll(".mxd-gravity-section");
    if (!e.length) return;
    const t = {
        x: 0,
        y: 1
    ...
    function c(e) {
        o = Matter.Engine.create(), o.gravity = t, o.constraintIterations = 10, o.positionIterations = 20, o.velocityIterations = 16, o.timing.timeScale = 1;
        const c = e.getBoundingClientRect(),
            l = 200,
            d = [Matter.Bodies.rectangle(c.width / 2, c.height + 100, c.width + 400, l, {
                isStatic: !0
            }), Matter.Bodies.rectangle(-100, c.height / 2, l, c.height + 400, {
                isStatic: !0
            }), Matter.Bodies.rectangle(c.width + 100, c.height / 2, l, c.height + 400, {
                isStatic: !0
            })];
        Matter.World.add(o.world, d), e.querySelectorAll(".object").forEach((e, t) => {
            if ("IMG" === e.tagName || e.querySelector("img")) {
                const t = "IMG" === e.tagName ? e : e.querySelector("img");
                t.draggable = !1, t.style.pointerEvents = "none"
            }
            const r = e.getBoundingClientRect(),
                n = Math.random() * (c.width - r.width) + r.width / 2,
                s = -500 - 200 * t,
                i = (Math.random() - .5) * Math.PI,
                l = Matter.Bodies.rectangle(n, s, r.width, r.height, {
                    restitution: .5,
                    friction: .15,
                    frictionAir: .02,
                    density: .002
                });
            Matter.Body.setAngle(l, i), a.push({
                body: l,
                element: e,
                width: r.width,
                height: r.height
            }), Matter.World.add(o.world, l)
        }), setTimeout(() => {
            s = Matter.Bodies.rectangle(c.width / 2, -100, c.width + 400, l, {
                isStatic: !0
            }), Matter.World.add(o.world, s)
        }, 5e3);
        const p = Matter.Mouse.create(e);
        p.element.removeEventListener("mousewheel", p.mousewheel), p.element.removeEventListener("DOMMouseScroll", p.mousewheel), n = Matter.MouseConstraint.create(o, {
            mouse: p,
            constraint: {
                stiffness: .6,
                render: {
        ...
        }), n.mouse.element.oncontextmenu = () => !1;
        let u = null,
            m = null;
        Matter.Events.on(n, "startdrag", function(e) {
                u = e.body, u && (m = u.inertia, Matter.Body.setInertia(u, 1 / 0), Matter.Body.setVelocity(u, {
                    x: 0,
                    y: 0
                }), Matter.Body.setAngularVelocity(u, 0))
            }), Matter.Events.on(n, "enddrag", function() {
                u && (Matter.Body.setInertia(u, m || 1), u = null, m = null)
            }), Matter.Events.on(o, "beforeUpdate", function() {
                if (u) {
                    const e = a.find(e => e.body === u);
                    if (e) {
                        const t = e.width / 2,
                            o = c.width - e.width / 2,
                            r = e.height / 2,
                            n = c.height - e.height / 2;
                        Matter.Body.setPosition(u, {
                            x: i(u.position.x, t, o),
                            y: i(u.position.y, r, n)
                        }), Matter.Body.setVelocity(u, {
                            x: i(u.velocity.x, -20, 20),
                            y: i(u.velocity.y, -20, 20)
                        })
                    }
                }
            }), e.addEventListener("mouseleave", () => {
                n.constraint.bodyB = null, n.constraint.pointB = null
            }), e.addEventListener("mouseup", () => {
                n.constraint.bodyB = null, n.constraint.pointB = null
            }), Matter.World.add(o.world, n), r = Matter.Runner.create(), Matter.Runner.run(r, o),
            function e() {
                a.forEach(({
                    body: e,
                    element: t,
                    ...
                    const n = i(e.position.x - o / 2, 0, c.width - o),
                        a = i(e.position.y - r / 2, 3 * -r, c.height - r);
                    t.style.left = n + "px", t.style.top = a + "px", t.style.transform = `rotate(${e.angle}rad)`
                }), requestAnimationFrame(e)
            }(), document.querySelectorAll(".object-image img").forEach(e => {
                e.addEventListener("dragstart", e => e.preventDefault())
            })
    }
    e.forEach(e => {
        const t = e.querySelector(".object-container");
        ...
        ScrollTrigger.refresh();
        const e = document.querySelector(".object-container");
        e && c(e), console.log("Function relaunched on window resize!")
    })
}
        ...
        class o {
            constructor(e) {
                this.DOM = {
                    ...
                    x: 0,
                    y: 0
                }, this.rect = this.DOM.el.getBoundingClientRect(), gsap.set(this.DOM.el, this.defaultStyle), window.addEventListener("resize", () => {
                    gsap.set(this.DOM.el, this.defaultStyle), this.rect = this.DOM.el.getBoundingClientRect()
                })
            }
            isActive() {
                return gsap.getTweensOf(this.DOM.el).length > 0 || "0" !== this.DOM.el.style.opacity
            }
        }
        class r {
            constructor(e) {
                this.section = e, this.wrapper = e.querySelector(".mxd-trail-wrapper"), this.content = this.wrapper.querySelector(".mxd-trail-content"), this.images = [...this.content.querySelectorAll(".mxd-trail-image")].map(e => new o(e)), this.total = this.images.length, this.mousePos = {
                    x: 0,
                    y: 0
                }, this.prevMousePos = {
                    x: 0,
                    ...
                    x: 0,
                    y: 0
                }, this.index = 0, this.zIndex = 1, this.threshold = 80, this.section.addEventListener("pointermove", e => this.onMove(e)), requestAnimationFrame(() => this.update())
            }
            onMove(e) {
            ...
            update() {
                const e = this.mousePos.x - this.prevMousePos.x,
                    ...
                    r = ((e, t, o, r) => Math.hypot(o - e, r - t))(this.mousePos.x, this.mousePos.y, this.prevMousePos.x, this.prevMousePos.y);
                this.cachedPos.x = t(this.cachedPos.x, this.mousePos.x, .12), this.cachedPos.y = t(this.cachedPos.y, this.mousePos.y, .12), r > this.threshold && (this.showNext(e, o), this.prevMousePos = { ...this.mousePos
                }), this.images.some(e => e.isActive()) || (this.zIndex = 1), requestAnimationFrame(() => this.update())
            }
            showNext(e, t) {
                const o = this.images[this.index],
                    r = gsap.utils.clamp(-14, 14, .4 * -(e + t));
                gsap.killTweensOf(o.DOM.el), gsap.timeline().set(o.DOM.el, {
                    opacity: 1,
                    scale: 1,
                    zIndex: this.zIndex++,
                ...
                }, .35), this.index = (this.index + 1) % this.total
            }
        }
        e.forEach(e => new r(e))
    })
    ...
    t.length && imagesLoaded(t, () => {
        ...
        class o {
            constructor(e) {
                this.DOM = {
                    el: e
                }, this.setSize(), this.rect = this.DOM.el.getBoundingClientRect()
            }
            setSize() {
                const e = this.DOM.el;
                e.naturalWidth >= e.naturalHeight ? (e.style.width = "240px", e.style.height = "auto") : (e.style.height = "240px", e.style.width = "auto")
            }
            updateRect() {
        ...
        class r {
            constructor(e) {
                this.section = e, this.wrapper = e.querySelector(".mxd-trail-transparent-wrapper"), this.content = this.wrapper.querySelector(".mxd-trail-transparent-content"), this.images = [...this.content.querySelectorAll(".mxd-trail-transparent-image")].map(e => new o(e)), this.mousePos = {
                    x: 0,
                    y: 0
                }, this.prevPos = {
                    x: 0,
                    ...
                    x: 0,
                    y: 0
                }, this.index = 0, this.zIndex = 1, this.threshold = 120, this.section.addEventListener("pointermove", e => this.move(e)), requestAnimationFrame(() => this.update())
            }
            move(e) {
                const t = this.wrapper.getBoundingClientRect();
            ...
            update() {
                const e = this.mousePos.x - this.prevPos.x,
                    ...
                    r = ((e, t, o, r) => Math.hypot(o - e, r - t))(this.mousePos.x, this.mousePos.y, this.prevPos.x, this.prevPos.y);
                this.cachedPos.x = t(this.cachedPos.x, this.mousePos.x, .14), this.cachedPos.y = t(this.cachedPos.y, this.mousePos.y, .14), r > this.threshold && (this.showNext(e, o), this.prevPos = { ...this.mousePos
                }), this.images.some(e => e.isActive()) || (this.zIndex = 1), requestAnimationFrame(() => this.update())
            }
            showNext(e, t) {
                const o = this.images[this.index];
                o.updateRect();
                const r = gsap.utils.clamp(-14, 14, .3 * -(e + t)),
                    n = o.rect.width / 2,
                    a = o.rect.height / 2;
                gsap.killTweensOf(o.DOM.el), gsap.timeline().set(o.DOM.el, {
                    opacity: 1,
                ...
                }, .55), this.index = (this.index + 1) % this.images.length
            }
        }
        e.forEach(e => new r(e))
    })
...
function mxdTextScramble(e = ".mxd-scramble") {
    document.querySelectorAll(e).forEach(e => {
        e.dataset.original || (e.dataset.original = e.textContent.trim());
        let t = null;
        e.addEventListener("mouseenter", () => {
            if (t) return;
            let o = 0;
            t = setInterval(() => {
                e.innerText = e.innerText.split("").map((t, r) => r < o ? e.dataset.original[r] : "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789" [Math.floor(36 * Math.random())]).join(""), o >= e.dataset.original.length && (clearInterval(t), t = null), o += .25
            }, 40)
        })
    })
}
...
function mxdHoverSlideshow() {
    document.querySelectorAll(".mxd-img-anim").forEach(e => {
        const t = e.querySelector(".mxd-img-anim__main"),
            o = e.querySelectorAll(".mxd-img-anim__absolute");
        let r = 0,
            n = null;
        t.style.opacity = "1", o.forEach(e => e.style.opacity = 0), e.addEventListener("mouseenter", () => {
            t.style.opacity = 0, r = 0, o[r].style.opacity = 1, n = setInterval(() => {
                o[r].style.opacity = 0, r = (r + 1) % o.length, o[r].style.opacity = 1
            }, 350)
        }), e.addEventListener("mouseleave", () => {
            clearInterval(n), o.forEach(e => e.style.opacity = 0), t.style.opacity = 1
        })
    })
}
...
function mxdProjectsStack() {
    ...
    e.length && e.forEach(e => {
        const t = gsap.utils.toArray(e.querySelectorAll(".mxd-stack-cards__card"));
        if (!t.length) return;
        const o = t[0];
        ...
        ScrollTrigger.create({
            ...
            onUpdate: e => {
                ...
                c >= 1 && !o.contentRevealed && (o.contentRevealed = !0, d(m, g)), c < 1 && o.contentRevealed && (o.contentRevealed = !1, p(m, g))
            }
        }), window.addEventListener("resize", () => {
            i = s(), l(c), ScrollTrigger.refresh()
        }), t.forEach((e, o) => {
            ...
            if (t > 0) {
                ...
                e.querySelector(".card__image"), ScrollTrigger.create({
                    trigger: e,
                    start: "top bottom",
                    end: "top top",
                    onUpdate: e => {
...
function mxdServicesStack() {
    ...
    e.length && e.forEach(e => {
        const t = gsap.utils.toArray(e.querySelectorAll(".mxd-stack-services__card"));
        t.length && (t.forEach(e => {
            ...
            t && o.length && (ScrollTrigger.create({
                trigger: e,
                start: "top 40%",
                onEnter: () => function(e) {
                    gsap.to(e, {
...
function mxdProjectsClip() {
    document.querySelectorAll(".mxd-showcase-clip").forEach(e => {
        ...
        t.forEach((e, t) => {
            ...
            else if (t === o.length - 1) gsap.timeline({
                scrollTrigger: {
                    trigger: e,
                    start: "top bottom",
                    end: "bottom bottom",
...
const initMarquees = () => {
        ...
        if (e) {
            ...
            e.forEach(e => {
                t.top.el = e.querySelectorAll(".marquee__top"), t.bottom.el = e.querySelectorAll(".marquee__bottom"), t.top.width = t.top.el.offsetWidth, t.bottom.width = t.bottom.el.offsetWidth, t.top.el.innerHTML += t.top.el.innerHTML, t.bottom.el.innerHTML += t.bottom.el.innerHTML;
                let o = gsap.timeline().add(marquee(t.top.el, 70, "-=50%"), 0).add(marquee(t.bottom.el, 70, "+=50%"), 0),
                    r = gsap.to(o, {
                        duration: 1.5,
                        timeScale: 1,
                        paused: !0
                ...
                ScrollTrigger.create({
                    ...
                    onUpdate: e => {
                        o.timeScale(n(Math.abs(e.getVelocity() / 200))), r.invalidate().restart()
                    }
                })
            })
        }
...
function mxdDvStickyMedia() {
    ...
    e.forEach(e => {
        ...
        c.textContent = o(p);
        const g = () => u * (window.innerHeight || document.documentElement.clientHeight),
            h = t => {
                const o = r.getBoundingClientRect().height || window.innerHeight;
                e.style.minHeight = o + t + "px"
            };
        (function(e) {
            const t = Array.from(e).flatMap(e => Array.from(e.querySelectorAll("img")));
            return t.length ? Promise.all(t.map(e => e.complete && (e.naturalWidth || e.naturalHeight) ? Promise.resolve() : e.decode ? e.decode().catch(() => {}) : new Promise(t => e.onload = e.onerror = t))) : Promise.resolve()
        })(n).then(() => {
            if (m(), p < 2) {
            ...
            ScrollTrigger.addEventListener("refresh", () => {
                const e = g();
                h(e), x.end = "+=" + e, y.pause(), y.progress(x.progress, !1)
            }), window.addEventListener("resize", ((e, t = 120) => {
                let o;
                return (...r) => {
                    clearTimeout(o), o = setTimeout(() => e(...r), t)
                }
            })(() => {
                ScrollTrigger.refresh()
            }, 150)), ScrollTrigger.refresh()
        }).catch(() => m())
    })
}
...
function mxdDvStickyCaption() {
    document.querySelectorAll(".mxd-dv-sticky-cap").forEach(e => {
        ...
        function s(e) {
            ...
            e.appendChild(t), Flip.from(o, {
                duration: .6,
                ease: "none",
                absolute: !0
            })
        }
        t && o && r && n && a && (ScrollTrigger.create({
            trigger: e,
            start: "top top",
            onEnter: () => s(r),
            onEnterBack: () => s(r),
...
animSlideUpWraps || animSlideUpWraps.forEach(e => {
    const t = e.firstElementChild;
    gsap.fromTo(t, {
        yPercent: 100,
        ease: "none"
...
function mxdHeroVideoScale() {
    ...
    function n() {
        o && (o.kill(), gsap.set(t, {
            ...
            const a = e[n + 1];
            if (!a) return;
            const s = r.getBoundingClientRect().top + window.pageYOffset + r.offsetHeight / 2,
                i = a.getBoundingClientRect().top + window.pageYOffset + a.offsetHeight / 2 - s;
            o.add(Flip.fit(t, a, {
                duration: i,
                ease: "none"
            }))
    ...
    function a() {
        clearTimeout(r), r = setTimeout(n, 100)
    }
    return n(), window.addEventListener("resize", a), () => {
        o && o.kill(), window.removeEventListener("resize", a), clearTimeout(r)
    }
}
...
function mxdHeroVideoSwap() {
    ...
    function r(t) {
        ...
        o = r,
            ...
            }(t), e.pause(), e.innerHTML = "";
        const n = document.createElement("source");
        n.src = e.dataset[`${r}Mp4`], n.type = "video/mp4";
        const a = document.createElement("source");
        a.src = e.dataset[`${r}Webm`], a.type = "video/webm", e.append(a, n), e.load(), e.play().catch(() => {})
    }
    r(t.matches), t.addEventListener("change", e => {
        r(e.matches)
    })
}
    ...
    o.forEach((e, t) => {
        ...
        onUpdate: e => {
            ...
            if (gsap.set(r, {
                ...
                } else t < .6 ? gsap.set(s.chars, {
                    opacity: 1
                }) : t > .75 && gsap.set(s.chars, {
                    opacity: 0
                });
            if (i && i.chars.length > 0)
                ...
                } else t < .8 ? gsap.set(i.chars, {
                    opacity: 0
                }) : t > .95 && gsap.set(i.chars, {
                    opacity: 1
                })
        }
    })
    ...
    ScrollTrigger.create({
        ...
        onUpdate: e => {
            ...
            const l = c / s,
                ...
                p = l - d;
            let u = p > .33 ? d + 1 : d;
            u = Math.max(0, Math.min(n - 1, u)), r.forEach((e, t) => {
                const o = e.querySelector("img");
                if (o)
                    if (t === d || t === d + 1) {
                        const e = t === d ? p : p - 1;
...
function mxdHeroBannersHover() {
    ...
    r.forEach(e => {
        e.trigger && e.banners.length && (gsap.set(e.banners, {
        ...
        e.trigger && e.tl && e.trigger.addEventListener("mouseenter", () => {
            o || t === e || (t ? (o = !0, t.tl.eventCallback("onReverseComplete", () => {
                t = e, e.tl.play(), o = !1
            }), t.tl.reverse()) : (t = e, e.tl.play()))
        })
    }), e.addEventListener("mouseleave", () => {
        t && !o && (o = !0, t.tl.eventCallback("onReverseComplete", () => {
            t = null, o = !1
        }), t.tl.reverse())
    })
}
